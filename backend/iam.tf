  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:sqs:${var.aws_region}:*:${var.lambda_function_name}-*"
        ]
      },
      {
        Effect = "Allow"
        ...
        Resource = [
          "arn:aws:s3:::${var.lambda_function_name}-images-*/*"
        ]
      },
      {
        Effect = "Allow"
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.lambda_function_name}-*",
