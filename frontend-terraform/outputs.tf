...
output "cloudfront_domain_name" {
  description = "CloudFront distribution domain name for NewsArchive Pro React application (e.g., d123456.cloudfront.net)"
...
output "website_url" {
  description = "Primary HTTPS URL for accessing the NewsArchive Pro React application"
...
output "infrastructure_info" {
  description = "Summary of deployed frontend infrastructure for NewsArchive Pro"
  value = {
    project = "NewsArchive Pro - Historical Newspaper Digitization Platform"
